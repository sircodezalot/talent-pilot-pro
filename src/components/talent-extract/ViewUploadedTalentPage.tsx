...
export const ViewUploadedTalentPage = ({ selectedProjectId, onBackToProjects }: ViewUploadedTalentPageProps) => {
  ...
  const [cvData, setCvData] = useState<CVData[]>([
    ...
    {
      id: "16",
      fileName: "jessica_miller_cv.pdf",
      uploadDate: "2023-12-31",
      status: "completed",
      firstName: "Jessica",
      lastName: "Miller",
      email: "jessica.miller@email.com",
      contactNumber: "+1-555-1037",
      matchPercentage: 89,
      projectId: "1",
      projectName: "Frontend Developer Hiring"
    },
    {
      id: "17",
      fileName: "david_harris_resume.pdf",
      uploadDate: "2023-12-30",
      status: "completed",
      firstName: "David",
      lastName: "Harris",
      email: "david.harris@email.com",
      contactNumber: "+1-555-1148",
      matchPercentage: 85,
      projectId: "2",
      projectName: "Backend Engineer Recruitment"
    },
    {
      id: "18",
      fileName: "olivia_thompson_cv.pdf",
      uploadDate: "2023-12-29",
      status: "completed",
      firstName: "Olivia",
      lastName: "Thompson",
      email: "olivia.thompson@email.com",
      contactNumber: "+1-555-1259",
      matchPercentage: 92,
      projectId: "3",
      projectName: "Full Stack Developer Search"
    },
    {
      id: "19",
      fileName: "christopher_moore_resume.pdf",
      uploadDate: "2023-12-28",
      status: "completed",
      firstName: "Christopher",
      lastName: "Moore",
      email: "christopher.moore@email.com",
      contactNumber: "+1-555-1360",
      matchPercentage: 87,
      projectId: "4",
      projectName: "DevOps Engineer Hiring"
    },
    {
      id: "20",
      fileName: "natalie_young_cv.pdf",
      uploadDate: "2023-12-27",
      status: "completed",
      firstName: "Natalie",
      lastName: "Young",
      email: "natalie.young@email.com",
      contactNumber: "+1-555-1471",
      matchPercentage: 90,
      projectId: "1",
      projectName: "Frontend Developer Hiring"
    },
    {
      id: "21",
      fileName: "matthew_hall_resume.pdf",
      uploadDate: "2023-12-26",
      status: "completed",
      firstName: "Matthew",
      lastName: "Hall",
      email: "matthew.hall@email.com",
      contactNumber: "+1-555-1582",
      matchPercentage: 83,
      projectId: "2",
      projectName: "Backend Engineer Recruitment"
    },
    {
      id: "22",
      fileName: "lauren_walker_cv.pdf",
      uploadDate: "2023-12-25",
      status: "completed",
      firstName: "Lauren",
      lastName: "Walker",
      email: "lauren.walker@email.com",
      contactNumber: "+1-555-1693",
      matchPercentage: 91,
      projectId: "3",
      projectName: "Full Stack Developer Search"
    },
    {
      id: "23",
      fileName: "ryan_adams_resume.pdf",
      uploadDate: "2023-12-24",
      status: "completed",
      firstName: "Ryan",
      lastName: "Adams",
      email: "ryan.adams@email.com",
      contactNumber: "+1-555-1704",
      matchPercentage: 86,
      projectId: "4",
      projectName: "DevOps Engineer Hiring"
    },
    {
      id: "24",
      fileName: "hannah_scott_cv.pdf",
      uploadDate: "2023-12-23",
      status: "completed",
      firstName: "Hannah",
      lastName: "Scott",
      email: "hannah.scott@email.com",
      contactNumber: "+1-555-1815",
      matchPercentage: 88,
      projectId: "1",
      projectName: "Frontend Developer Hiring"
    },
    {
      id: "25",
      fileName: "jordan_nelson_resume.pdf",
      uploadDate: "2023-12-22",
      status: "completed",
      firstName: "Jordan",
      lastName: "Nelson",
      email: "jordan.nelson@email.com",
      contactNumber: "+1-555-1926",
      matchPercentage: 84,
      projectId: "2",
      projectName: "Backend Engineer Recruitment"
    },
    {
      id: "26",
      fileName: "victoria_king_cv.pdf",
      uploadDate: "2023-12-21",
      status: "completed",
      firstName: "Victoria",
      lastName: "King",
      email: "victoria.king@email.com",
      contactNumber: "+1-555-2037",
      matchPercentage: 93,
      projectId: "3",
      projectName: "Full Stack Developer Search"
    },
    {
      id: "27",
      fileName: "brandon_wright_resume.pdf",
      uploadDate: "2023-12-20",
      status: "completed",
      firstName: "Brandon",
      lastName: "Wright",
      email: "brandon.wright@email.com",
      contactNumber: "+1-555-2148",
      matchPercentage: 87,
      projectId: "4",
      projectName: "DevOps Engineer Hiring"
    },
    {
      id: "28",
      fileName: "stephanie_lopez_cv.pdf",
      uploadDate: "2023-12-19",
      status: "completed",
      firstName: "Stephanie",
      lastName: "Lopez",
      email: "stephanie.lopez@email.com",
      contactNumber: "+1-555-2259",
      matchPercentage: 89,
      projectId: "1",
      projectName: "Frontend Developer Hiring"
    },
    {
      id: "29",
      fileName: "tyler_hill_resume.pdf",
      uploadDate: "2023-12-18",
      status: "completed",
      firstName: "Tyler",
      lastName: "Hill",
      email: "tyler.hill@email.com",
      contactNumber: "+1-555-2360",
      matchPercentage: 85,
      projectId: "2",
      projectName: "Backend Engineer Recruitment"
    },
    {
      id: "30",
      fileName: "claire_baker_cv.pdf",
      uploadDate: "2023-12-17",
      status: "completed",
      firstName: "Claire",
      lastName: "Baker",
      email: "claire.baker@email.com",
      contactNumber: "+1-555-2471",
      matchPercentage: 90,
      projectId: "3",
      projectName: "Full Stack Developer Search"
    },
    {
      id: "31",
      fileName: "austin_gonzalez_resume.pdf",
      uploadDate: "2023-12-16",
      status: "completed",
      firstName: "Austin",
      lastName: "Gonzalez",
      email: "austin.gonzalez@email.com",
      contactNumber: "+1-555-2582",
      matchPercentage: 82,
      projectId: "4",
      projectName: "DevOps Engineer Hiring"
    },
    {
      id: "32",
      fileName: "megan_cooper_cv.pdf",
      uploadDate: "2023-12-15",
      status: "completed",
      firstName: "Megan",
      lastName: "Cooper",
      email: "megan.cooper@email.com",
      contactNumber: "+1-555-2693",
      matchPercentage: 91,
      projectId: "1",
      projectName: "Frontend Developer Hiring"
    },
    {
      id: "33",
      fileName: "jacob_ward_resume.pdf",
      uploadDate: "2023-12-14",
      status: "completed",
      firstName: "Jacob",
      lastName: "Ward",
      email: "jacob.ward@email.com",
      contactNumber: "+1-555-2704",
      matchPercentage: 86,
      projectId: "2",
      projectName: "Backend Engineer Recruitment"
    },
    {
      id: "34",
      fileName: "grace_torres_cv.pdf",
      uploadDate: "2023-12-13",
      status: "completed",
      firstName: "Grace",
      lastName: "Torres",
      email: "grace.torres@email.com",
      contactNumber: "+1-555-2815",
      matchPercentage: 88,
      projectId: "3",
      projectName: "Full Stack Developer Search"
    },
    {
      id: "35",
      fileName: "noah_peterson_resume.pdf",
      uploadDate: "2023-12-12",
      status: "completed",
      firstName: "Noah",
      lastName: "Peterson",
      email: "noah.peterson@email.com",
      contactNumber: "+1-555-2926",
      matchPercentage: 84,
      projectId: "4",
      projectName: "DevOps Engineer Hiring"
    }
